# Cyberdeck — Build Plan (journal snapshot, pre-2026-05-07)

> **STATUS: ARCHIVED 2026-05-07.** This is the old running-journal
> version of the build plan, preserved for provenance. The forward-
> looking material from this doc was lifted into the lean rebuilt
> `cyberdeck-build-plan.md` at the canon root. Read this if you need
> session-by-session history of what was deferred when, or to verify
> nothing was lost in the trim.

---

# Cyberdeck — Build Plan (original journal)
